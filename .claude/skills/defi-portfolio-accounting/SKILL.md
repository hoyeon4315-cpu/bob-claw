...
description: [LEGACY - Claude Code only] Use when handling aggressive sleeve accounting, sleeve PnL attribution, backtests, or reconciliation for aggressive-velocity-v1. This compatibility surface orchestrates the pure accounting library without embedding financial logic.
---

# DeFi Portfolio Accounting
