export function evaluateDestinationWrappedBtcRotationAdapter({ config, market, receipts, now }) {
...
export function buildDefaultDestinationWrappedBtcRotationConfig() {
  return { id: "destination_wrapped_btc_rotation" };
}
