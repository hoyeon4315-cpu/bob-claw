export function evaluateMacroAssetRotationAdapter({ config, market, receipts, now }) {
...
export function buildDefaultMacroAssetRotationConfig() {
  return { id: "macro_asset_rotation" };
}
