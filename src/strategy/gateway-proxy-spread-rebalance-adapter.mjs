export function evaluateGatewayProxySpreadRebalanceAdapter({ config, market, receipts, now }) {
...
export function buildDefaultGatewayProxySpreadRebalanceConfig() {
  return { id: "gateway_proxy_spread_rebalance_recheck" };
}
