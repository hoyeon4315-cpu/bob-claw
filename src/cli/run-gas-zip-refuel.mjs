...
export function parseArgs(argv) {
  ...
  return {
    ...
    minimumDestinationWei: options["minimum-destination-wei"] || null,
    requiredDestinationBalanceWei: options["required-destination-balance-wei"] || null,
...
async function main() {
  ...
  const plan = await buildGasZipNativeRefuelPlan({
    ...
    minimumDestinationWei: args.minimumDestinationWei,
    requiredDestinationBalanceWei: args.requiredDestinationBalanceWei,
