...
export const TOKEN_REGISTRY = Object.freeze({
  ...
  base: [
    ...
    { symbol: "apxUSD", address: "0xd993935e13851dd7517af10687ec7e5022127228", decimals: 18 },
  ],
  bsc: [
  ...
  sei: [{ symbol: "wBTC.OFT", address: "0x0555E30da8f98308EdB960aa94C0Db47230d2B9c", decimals: 8 }],
});
