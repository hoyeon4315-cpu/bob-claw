...
function summarizeMerklCanaryQueueStatus(queue = null) {
  ...
  return {
    ...
    actualBroadcastCount: summary.actualBroadcastCount ?? 0,
    ...
    topEvBlockers: summary.topEvBlockers || [],
    latestAutopilotObservedAt: summary.latestAutopilotObservedAt || null,
    latestAutopilotMode: summary.latestAutopilotMode || null,
