...
function auditSummary(audit) {
  return {
    ...
    advancedOverfitStatistics: audit.advancedOverfitStatistics || null,
    quotes: audit.quotes,
    validQuotes: audit.validQuotes,
    activeQuotes: audit.activeQuotes,
    shadowObservations: audit.shadowObservations,
    failures: audit.failures,
    activeFailures: audit.activeFailures,
    cloudflareFailures: audit.cloudflareFailures,
    gasSnapshots: audit.gasSnapshots,
    gasFailures: audit.gasFailures,
