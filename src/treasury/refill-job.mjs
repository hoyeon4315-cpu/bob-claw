  ...
  const jobs = (plan.actions || []).map((action) => {
    ...
    return {
      ...
      systemEconomics: {
        ...
        routeKnownCostUsd: resolvedFundingSourcePlan.routeContext?.knownCostUsd ?? null,
        routeFailureRate: resolvedFundingSourcePlan.routeContext?.routeFailureRate ?? null,
        executionRefillExpectedCostUsd: resolvedFundingSourcePlan.summary?.executionRefillExpectedCostUsd ?? null,
        reserveReplenishmentExpectedCostUsd: resolvedFundingSourcePlan.summary?.reserveReplenishmentExpectedCostUsd ?? null,
        expectedFailureCostUsd: resolvedFundingSourcePlan.summary?.expectedFailureCostUsd ?? null,
        capitalFragmentationDragUsd: resolvedFundingSourcePlan.summary?.capitalFragmentationDragUsd ?? null,
