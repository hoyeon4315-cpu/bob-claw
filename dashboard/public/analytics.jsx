// Privacy-bounded dashboard product analytics.
// PostHog delivery is disabled unless window.BOB_CLAW_ANALYTICS_CONFIG enables it.

const allowedProductAnalyticsEvents = new Set(["dashboard_view", "dashboard_tab_changed", "dashboard_interaction"]);
const allowedProductAnalyticsProperties = new Set([
  "surface",
  "view",
  "interaction",
  "component",
