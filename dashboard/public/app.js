...
function trackProductAnalytics(eventName, properties) {
  if (typeof window.trackProductAnalytics !== "function") return null;
  return window.trackProductAnalytics(eventName, properties);
}
function dashboardAnalyticsProperties(properties) {
  return { surface: "dashboard", ...properties };
}
function StatCard({ label, main, sub, accent, onTap, tappable }) {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8.5, color: "var(--ink-4)", letterSpacing: 1, textTransform: "uppercase" } }, label),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 600, letterSpacing: -0.3, marginTop: 2, color: accent || "var(--ink)" } }, main),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--ink-3)", marginTop: 0 } }, sub)
  );
}
function TriCard({ cells, compact = false }) {
  return /* @__PURE__ */ React.createElement(
    ...
    cells.map((c, i) => /* @__PURE__ */ React.createElement(React.Fragment, { key: c.label }, /* @__PURE__ */ React.createElement(
      "div",
      {
        onClick: c.onTap,
        style: {
      ...
      c.sub && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
    ...
    ), i < cells.length - 1 && /* @__PURE__ */ React.createElement("div", { style: { width: 0.5, background: "var(--line)" } })))
  );
}
...
function activityAmount(activity) {
  ...
  if (Number.isFinite(activity?.realizedNetPnlUsd) && activity.realizedNetPnlUsd !== 0)
    return fmtUsd(activity.realizedNetPnlUsd);
...
function weightedApyForStrategies(strategies = []) {
  const rows = (strategies || []).filter(
    (strategy) => strategy?.status === "LIVE" && Number.isFinite(strategy?.apyPct) && strategyApyWeightUsd(strategy) > 0
  );
...
function LiveLaneCard() {
  ...
  const remainingSats = Number(
    payback.carry?.remainingSatsToMinimum ?? payback.scheduler?.minimumPaybackProgress?.satsToMinimumPayback ?? NaN
  );
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("span", { style: { width: 6, height: 6, borderRadius: 6, background: gateTone.color, flexShrink: 0 } }),
      /* @__PURE__ */ React.createElement(
        "span",
        {
          style: {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      cells.map((cell) => {
        ...
        return /* @__PURE__ */ React.createElement("div", { key: cell.label, style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement(
          "div",
          {
            style: {
              fontSize: 7.4,
          ...
          cell.label
        ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 4, marginTop: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { width: 6, height: 6, borderRadius: 6, background: tone.color, flexShrink: 0 } }), /* @__PURE__ */ React.createElement(
          "span",
          {
            style: {
              fontSize: 10.8,
    ...
    refillTopBlocker ? /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          marginTop: 6,
      ...
      /* @__PURE__ */ React.createElement("div", { style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, "Scope ", friendlyBlockerLabel(refillTopScope?.scopeType || refillTopBlocker.scope?.scopeType || "job"), " \xB7", " ", refillTopScope?.chain || refillTopBlocker.chain || "chain", " \xB7", " ", refillTopScope?.targetAsset || refillTopBlocker.asset || "asset", " \xB7", " ", refillTopScope?.selectedMethod || refillTopBlocker.selectedMethod || "method"),
      /* @__PURE__ */ React.createElement("div", { style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, "Waiting helps: ", refill.waitingHelps ? "yes" : "no", " \xB7 Next", " ", friendlyBlockerLabel(refillTopAction || refillTopBlocker.nextOperatorAction || "operator_review_required")),
      refillTopDryRun ? /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            whiteSpace: "nowrap",
      ...
      refillTopSafeReset ? /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            whiteSpace: "nowrap",
...
function RouteNode({ kind = "text", id, label }) {
  return /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 5, minWidth: 0, flexShrink: 1 } }, kind === "chain" && id ? /* @__PURE__ */ React.createElement(ChainLogo, { id, size: 16 }) : null, kind === "protocol" && id ? /* @__PURE__ */ React.createElement(ProtocolLogo, { id, size: 16 }) : null, /* @__PURE__ */ React.createElement(
    "span",
    {
      style: {
        minWidth: 0,
...
function FlowActivityRow({ activity, isLast }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(RouteNode, { kind: route.source.kind, id: route.source.id, label: route.source.label }),
      /* @__PURE__ */ React.createElement("span", { style: { color: "var(--ink-4)", flexShrink: 0 } }, "\u2192"),
      /* @__PURE__ */ React.createElement(RouteNode, { kind: route.target.kind, id: route.target.id, label: route.target.label })
    ), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 5, minWidth: 0, marginTop: 4 } }, /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          fontSize: 10.4,
    ...
    )), riskLabel && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          fontSize: 8.9,
      ...
      riskLabel
    ), policyReason && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          fontSize: 8.9,
    ...
    /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right", flexShrink: 0, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          display: "inline-flex",
      ...
      finalAsset && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
            display: "inline-flex",
        ...
        /* @__PURE__ */ React.createElement(AssetLogo, { id: finalAsset.id, size: 11 }),
        /* @__PURE__ */ React.createElement(
          "span",
          {
            style: {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10.6, fontWeight: 700, letterSpacing: -0.15 } }, activityAmount(activity))
    ), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9.2, color: "var(--ink-3)", marginTop: 1 } }, fmtWhen(activity?.observedAt))),
    !isLast && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", left: 0, right: 0, bottom: 0, height: 0.5, background: "var(--line)" } })
  );
}
function OpsStrip({ fill = false, onExpandedChange = null }) {
  ...
  const inFlightTxCount = txActivities.filter(
    (activity) => activity?.status === "signed" || activity?.status === "broadcasted"
  ).length;
  ...
  const filteredActivities = activities.filter((activity) => {
    if (filter === "in_flight")
      return activity?.kind === "transaction" && (activity?.status === "signed" || activity?.status === "broadcasted");
  ...
  const filterChips = [
    ...
    {
      id: "in_flight",
      label: `In flight ${inFlightTxCount}`,
      tone: { bg: "#FFF4E2", fg: "#8A520C" },
      hidden: inFlightTxCount === 0
    },
    {
      id: "confirmed",
      label: `Confirmed ${confirmedTxCount}`,
      tone: { bg: "#EAF6EE", fg: "var(--green)" },
      hidden: confirmedTxCount === 0
    },
    {
      id: "tx",
      label: `TX ${txActivities.length}`,
      tone: { bg: "#ECECEE", fg: "var(--ink-3)" },
      hidden: txActivities.length === 0
    },
    {
      id: "position",
      label: `Position ${positionActivities.length}`,
      tone: { bg: "#EEF2FF", fg: "#3256D7" },
      hidden: positionActivities.length === 0
    },
    {
      id: "payback",
      label: `Payback ${paybackActivities.length}`,
      tone: { bg: "#FFF4E2", fg: "#8A520C" },
      hidden: paybackActivities.length === 0
    }
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          width: 22,
      ...
      "H"
    ), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10.4, fontWeight: 700, letterSpacing: 0.15 } }, "History"), /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          fontSize: 9,
    ...
    ), filterChips.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 4, marginTop: 3 } }, filterChips.map((chip) => {
    ...
    /* @__PURE__ */ React.createElement(
      ...
      filteredActivities.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--ink-4)", padding: "4px 0 2px" } }, "No matching capital move yet."),
      visibleActivities.map((activity, index) => /* @__PURE__ */ React.createElement(
        FlowActivityRow,
        {
...
function PnlBreakdownStrip({ inline = false }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { marginTop: inline ? 5 : 6 } }, /* @__PURE__ */ React.createElement(
      TriCard,
      {
        compact: true,
        cells: [
    ...
    topKinds.length > 0 && /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
      ...
      "Top drags:",
      " ",
      topKinds.map((item) => `${pnlKindLabel(item.kind)} ${fmtUsd(item.realizedNetPnlUsd)}`).join(" \xB7 ")
    )
  );
}
function FlowPane({ refreshTick }) {
  ...
  const {
    ...
    displayAssetUsd
  } = summarizeDashboardAssets(HOLDINGS, items, positions);
  ...
  const strategyYieldUsd = STRATEGIES.reduce(
    (sum, strategy) => sum + (Number.isFinite(strategy?.earnedUsd) ? strategy.earnedUsd : 0),
    0
  );
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(Mindmap, { motionSpeed: 1.4, refreshTick, onFocusChange: setMindmapFocus })
      )
    ),
    /* @__PURE__ */ React.createElement(
      "div",
      ...
      /* @__PURE__ */ React.createElement(
        ...
        !historyExpanded && /* @__PURE__ */ React.createElement(
          FlowMetricGrid,
          {
            cards: [
              {
        ...
        !historyExpanded && aprOpen && /* @__PURE__ */ React.createElement(
          "div",
          {
            style: {
              margin: "0 12px",
        ...
        /* @__PURE__ */ React.createElement(OpsStrip, { fill: historyExpanded, onExpandedChange: setHistoryExpanded })
      )
    )
  );
}
function KpiCard({ label, main, sub }) {
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      style: { padding: "12px 14px", background: "var(--card)", borderRadius: 16, border: "0.5px solid var(--line)" }
    },
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9.5, color: "var(--ink-4)", letterSpacing: 1.3, textTransform: "uppercase" } }, label),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 600, letterSpacing: -0.3, marginTop: 3 } }, main),
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-3)", marginTop: 1 } }, sub)
  );
}
function DefiPane({ refreshTick }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "tabpane", style: { padding: "4px 12px 16px" } }, /* @__PURE__ */ React.createElement(LiveLaneCard, null), /* @__PURE__ */ React.createElement(OnchainRadarCard, null), /* @__PURE__ */ React.createElement(DevAgentQueueCard, null), /* @__PURE__ */ React.createElement(PnlBreakdownStrip, { inline: true }), /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 700, color: "var(--ink)" } }, "Strategy coverage"),
    /* @__PURE__ */ React.createElement("span", null, watchedCount, " watched \xB7 ", candidateCount, " candidate/review \xB7 ", openPositionCount, " open")
  ), entries.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "40px 16px", textAlign: "center", fontSize: 13, color: "var(--ink-3)" } }, "No live strategies"), entries.map(([proto, list]) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { padding: "0 12px" } }, list.map((s, i) => /* @__PURE__ */ React.createElement(StrategyRow, { key: s.id, s, isLast: i === list.length - 1 })))
    );
  }));
}
function OnchainRadarCard() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 8 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8.7, color: "var(--ink-4)", letterSpacing: 1.2, textTransform: "uppercase" } }, "Onchain radar"), /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          fontSize: 10,
      ...
      "read-only \xB7 no signing \xB7 ",
      radar.headline || "Waiting for observations"
    )), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9.5, color: "var(--ink-3)", textAlign: "right", whiteSpace: "nowrap" } }, fmtWhen(radar.generatedAt))),
    /* @__PURE__ */ React.createElement("div", { style: { marginTop: 7 } }, /* @__PURE__ */ React.createElement(
      TriCard,
      {
        compact: true,
        cells: [
...
function DevAgentQueueCard() {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 8.7, color: "var(--ink-4)", letterSpacing: 1.2, textTransform: "uppercase" } }, "LLM dev queue"), /* @__PURE__ */ React.createElement(
      ...
      "code tasks \xB7 runtime ",
      runtimeAuthority,
      " \xB7 no signing"
    )), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9.5, color: "var(--ink-3)", whiteSpace: "nowrap" } }, fmtWhen(bridge.generatedAt))),
    /* @__PURE__ */ React.createElement("div", { style: { marginTop: 7 } }, /* @__PURE__ */ React.createElement(
      TriCard,
      {
        compact: true,
...
function StrategyRow({ s, isLast }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: 44, height: 30, flexShrink: 0 } }, /* @__PURE__ */ React.createElement(ChainLogo, { id: s.chain, size: 24, style: { position: "absolute", left: 0, top: 3 } }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", right: 0, bottom: 0 } }, /* @__PURE__ */ React.createElement(AssetPairMarks, { pair: s.pair, size: 14 })), live && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          position: "absolute",
    ...
    /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
      ...
      chain?.name || displayChainName(s.chain),
      " \xB7 ",
      strategyKind(s),
      s.apyPct != null ? ` \xB7 APR ${s.apyPct.toFixed(2)}%` : ""
    ), /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
...
function protocolTrackingTone(position = {}) {
  if (position?.markFailureKind === "no_reader_no_adapter" || position?.markFailureKind === "missing_binding_kind")
    return "warning";
...
function summarizeDashboardAssets(HOLDINGS, items, positions) {
  const totalUsd = Number.isFinite(HOLDINGS?.totalUsd) ? HOLDINGS.totalUsd : items.reduce((s, a) => s + (a.usd || 0), 0) + positions.reduce((s, a) => s + (a.usd || 0), 0);
...
function AssetsPane({ refreshTick }) {
  ...
  const trackingOldestSourceLabel = tracking?.oldestMaterialSourceObservedAt ? `oldest source ${formatStatusAge(tracking.oldestMaterialSourceObservedAt) || fmtWhen(tracking.oldestMaterialSourceObservedAt)}` : null;
  const trackingDriftLabel = Number.isFinite(tracking?.trackingDriftUsd) && tracking.trackingDriftUsd > 0 ? `tracking drift ${fmtUsd(tracking.trackingDriftUsd)}` : null;
  const trackingDriftTone = tracking?.trackingDriftStatus === "blocked" ? "critical" : tracking?.trackingDriftStatus === "warn" ? "warning" : "neutral";
  const visibilityTone = tracking?.visibilityState === "current" ? "ok" : tracking?.visibilityState === "quarantined" ? "critical" : tracking?.visibilityState === "stale" || tracking?.visibilityState === "drift" ? "warning" : "neutral";
  ...
  const assetIsVerifiedFloor = HOLDINGS?.assetConfidence === "verified_minimum";
  const assetHasReconciliationGap = protocolTrackingGapUsd > 1 || Boolean(HOLDINGS?.accountingWarning);
  const assetHeadline = tracking && !Number.isFinite(trackingExactTotalUsd) ? tracking.dashboardHeadline || "Verified known assets only" : assetEstimateAvailable ? "Estimated total assets" : assetIsVerifiedFloor ? "Verified minimum assets" : assetHasReconciliationGap ? "Observed assets" : "Current total assets";
  const assetEquationTotalLabel = tracking && !Number.isFinite(trackingExactTotalUsd) ? "verified known" : assetEstimateAvailable ? "estimated total" : assetIsVerifiedFloor || assetHasReconciliationGap ? "verified minimum" : "current total";
  ...
  void refreshTick;
  return /* @__PURE__ */ React.createElement("div", { className: "tabpane", style: { padding: "4px 16px 16px" } }, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        padding: "14px 16px",
    ...
    /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: "var(--ink-4)", letterSpacing: 1.4, textTransform: "uppercase" } }, assetHeadline),
    /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: 6, marginTop: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 28, fontWeight: 600, letterSpacing: -0.8 } }, pending ? "\u2014" : assetMain), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: "var(--ink-3)" } }, "USD")),
    !pending && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-3)", marginTop: 2 } }, assetEstimateAvailable ? "estimated live " : assetHasReconciliationGap ? "observed live " : "", "remaining", " ", fmtUsd(currentWalletUsd), " + ", assetEstimateAvailable ? "estimated" : "tracked", " protocols", " ", fmtUsd(assetEstimateAvailable ? estimatedProtocolDeployedUsd : protocolDeployedUsd), " =", " ", assetEquationTotalLabel, " ", fmtUsd(displayAssetUsd), assetEstimateAvailable && /* @__PURE__ */ React.createElement(React.Fragment, null, " \xB7 ", "verified minimum ", fmtUsd(verifiedMinimumUsd)), protocolTrackingGapUsd > 1 && /* @__PURE__ */ React.createElement(React.Fragment, null, " \xB7 ", "unreconciled protocol estimate ", fmtUsd(protocolTrackingGapUsd)), tracking && Number.isFinite(trackingRiskUsableUsd) && /* @__PURE__ */ React.createElement(React.Fragment, null, " \xB7 ", "risk usable ", fmtUsd(trackingRiskUsableUsd)), " \xB7 ", "live supported ", fmtUsd(HOLDINGS?.walletUsd), " \xB7 ", "open positions ", positions.length),
    !pending && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, marginTop: 8 } }, /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
      ...
      "span",
      {
        style: {
          ...
          padding: "3px 7px",
          borderRadius: 999,
          background: HOLDINGS?.walletScanErrorCount > 0 ? "#FFF6E8" : "rgba(255,255,255,0.06)",
          color: HOLDINGS?.walletScanErrorCount > 0 ? "var(--orange)" : "var(--ink-3)",
          border: HOLDINGS?.walletScanErrorCount > 0 ? "0.5px solid rgba(201,140,0,0.22)" : "0.5px solid var(--line)"
        }
      },
      walletScanHealthLabel
    ), externalScanLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
      ...
      externalScanLabel
    ), fullWalletAgeLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          padding: "3px 7px",
          borderRadius: 999,
          background: HOLDINGS?.fullWalletStale ? "#FFF6E8" : "rgba(255,255,255,0.06)",
          color: HOLDINGS?.fullWalletStale ? "var(--orange)" : "var(--ink-3)",
          border: HOLDINGS?.fullWalletStale ? "0.5px solid rgba(201,140,0,0.22)" : "0.5px solid var(--line)"
        }
      },
      fullWalletAgeLabel
    ), unclassifiedLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          ...
          background: "#FFF6E8",
          color: "var(--orange)",
          border: "0.5px solid rgba(201,140,0,0.22)"
        }
      },
      unclassifiedLabel
    ), assetIsVerifiedFloor && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
      ...
      "verified minimum ",
      fmtUsd(verifiedMinimumUsd)
    ), tracking && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          padding: "3px 7px",
          borderRadius: 999,
          ...statusChipStyle(trackingRiskReady ? "ok" : "critical")
        }
      },
      trackingRiskReady ? "risk-ready exact" : "not exact for sizing"
    ), tracking?.verdict && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle(trackingVerdictTone) }
      },
      "asset tracking ",
      tracking.verdict
    ), trackingOldestSourceLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          ...
          borderRadius: 999,
          ...statusChipStyle(
            tracking?.staleItemCount > 0 || tracking?.stalePriceItemCount > 0 ? "warning" : "neutral"
          )
        }
      },
      trackingOldestSourceLabel
    ), tracking?.visibilityState && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle(visibilityTone) } }, "visibility ", tracking.visibilityState), trackingDriftLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle(trackingDriftTone) }
      },
      trackingDriftLabel
    ), tracking?.quarantinedAssetCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("critical") } }, "quarantined ", tracking.quarantinedAssetCount), tracking?.doubleCountPreventedCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("ok") } }, "double count prevented ", tracking.doubleCountPreventedCount), pendingWhitelistCount > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("warning") } }, "pending whitelist ", pendingWhitelistCount), tracking && Number.isFinite(trackingExactTotalUsd) && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("ok") } }, "exact total ", fmtUsd(trackingExactTotalUsd)), tracking && !Number.isFinite(trackingExactTotalUsd) && Number.isFinite(trackingRiskUsableUsd) && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("critical") } }, "risk usable ", fmtUsd(trackingRiskUsableUsd)), tracking && trackingBlockers.slice(0, 3).map((item) => /* @__PURE__ */ React.createElement(
      "span",
      {
        key: item.code,
        style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("warning") }
      },
      String(item.code || "tracking_gap").replace(/_/g, " ")
    )), protocolTrackingGapUsd > 1 && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
      ...
      "protocol tracking gap ",
      fmtUsd(protocolTrackingGapUsd)
    ), planEstimateLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          padding: "3px 7px",
          borderRadius: 999,
          background: HOLDINGS?.accountingWarning ? "#FFF6E8" : "rgba(255,255,255,0.06)",
          color: HOLDINGS?.accountingWarning ? "var(--orange)" : "var(--ink-3)",
          border: HOLDINGS?.accountingWarning ? "0.5px solid rgba(201,140,0,0.22)" : "0.5px solid var(--line)"
        }
      },
      planEstimateLabel
    ), planGapLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
      ...
      planGapLabel
    ), estimateGapLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
      ...
      estimateGapLabel
    ), systemConfidenceLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          ...
          borderRadius: 999,
          ...statusChipStyle(
            HOLDINGS?.systemConfidence === "high" ? "ok" : HOLDINGS?.systemConfidence === "medium" ? "warning" : "critical"
          )
        }
      },
      ...
      "span",
      {
        style: {
          ...
          padding: "3px 7px",
          borderRadius: 999,
          ...statusChipStyle(HOLDINGS?.invariantViolationCount > 0 ? "warning" : "ok")
        }
      },
      invariantAlertLabel
    ), protocolMarkHealthLabel && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontSize: 10,
          padding: "3px 7px",
          borderRadius: 999,
          ...statusChipStyle(Number(HOLDINGS?.protocolMarkIssueCount || 0) > 0 ? "warning" : "ok")
        }
      },
      protocolMarkHealthLabel
    ), protocolMarkObservedLabel && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("neutral") } }, protocolMarkObservedLabel), adapterCoverageLabel && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("warning") } }, adapterCoverageLabel), pendingSignerLabel && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, padding: "3px 7px", borderRadius: 999, ...statusChipStyle("warning") } }, pendingSignerLabel)),
    pending && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-4)", marginTop: 2 } }, "treasury snapshot pending")
  ), /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
    ...
    "div",
    {
      style: { background: "var(--card)", borderRadius: 18, border: "0.5px solid var(--line)", overflow: "hidden" }
    },
    items.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "18px 14px", fontSize: 12, color: "var(--ink-4)", textAlign: "center" } }, "no balance feed wired yet"),
    items.map((a, i, arr) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(AssetLogo, { id: a.sym, size: 28 }),
        /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, fontWeight: 500 } }, a.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-3)", marginTop: 1 } }, /* @__PURE__ */ React.createElement(WalletBalanceChainLabel, { chainId: a.chain, label: chainLabel })), (a.sourceObservedAt || a.priceObservedAt || a.freshness || a.priceFreshness) && /* @__PURE__ */ React.createElement(
          "div",
          {
            style: {
              fontSize: 10,
          ...
          a.freshness ? ` \xB7 ${String(a.freshness).replace(/_/g, " ")}` : "",
          a.priceObservedAt ? ` \xB7 price ${formatStatusAge(a.priceObservedAt) || fmtWhen(a.priceObservedAt)}` : "",
          a.priceFreshness ? ` \xB7 ${String(a.priceFreshness).replace(/_/g, " ")}` : ""
        ), tied.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 4, marginTop: 6 } }, tied.slice(0, 4).map((s) => /* @__PURE__ */ React.createElement(
          "span",
          {
            key: s.id,
            style: {
          ...
          " \xB7 ",
          s.protocol
        )), tied.length > 4 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9.5, color: "var(--ink-4)", padding: "2px 4px" } }, "+", tied.length - 4))),
        /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 600, letterSpacing: -0.2 } }, "$", (a.usd || 0).toLocaleString()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-3)", marginTop: 1 } }, isExternalDelta ? "external scan delta" : `${(a.amount || 0).toLocaleString()} ${a.name}`)),
        i !== arr.length - 1 && /* @__PURE__ */ React.createElement(
          "div",
          {
            style: {
              position: "absolute",
  ...
  ), positions.length > 0 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        fontSize: 10.5,
    ...
    positions.map((p, i, arr) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: (p.opportunityId || p.name) + i,
        style: {
          display: "flex",
          alignItems: "flex-start",
          gap: 12,
      ...
      /* @__PURE__ */ React.createElement(ProtocolLogo, { id: p.protocol, size: 28 }),
      /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, fontWeight: 500, lineHeight: 1.25 } }, p.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-3)", marginTop: 2 } }, p.chain, " \xB7 ", p.protocol), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 4, marginTop: 6 } }, /* @__PURE__ */ React.createElement(
        "span",
        {
          style: {
            fontSize: 9.5,
            padding: "2px 6px",
            borderRadius: 999,
            ...statusChipStyle(protocolTrackingTone(p))
          }
        },
        protocolTrackingLabel(p)
      ), p.markConfidence && /* @__PURE__ */ React.createElement(
        "span",
        {
          style: {
            fontSize: 9.5,
            padding: "2px 6px",
            borderRadius: 999,
            ...statusChipStyle(p.markConfidence === "verified_current" ? "ok" : "warning")
          }
        },
        String(p.markConfidence).replace(/_/g, " ")
      ), p.markObservedAt && /* @__PURE__ */ React.createElement(
        "span",
        {
          style: { fontSize: 9.5, padding: "2px 6px", borderRadius: 999, ...statusChipStyle("neutral") }
        },
        "mark ",
        formatStatusAge(p.markObservedAt) || fmtWhen(p.markObservedAt)
      ))),
      /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 600, letterSpacing: -0.2 } }, fmtUsd(p.usd || 0)), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10.5, color: "var(--green)", marginTop: 1 } }, "deployed")),
      i !== arr.length - 1 && /* @__PURE__ */ React.createElement(
        "div",
        {
          style: {
