...
- **Small-capital sleeve caps (<$1,000 operating capital):**
  ...
  - Per campaign: $25 initial cap for non-canary entries, $50 max unless a committed diff raises it after realized-positive evidence. This is a cap, not a minimum notional floor; the committed tiny-canary ladder may use smaller predeclared rungs when deterministic policy still shows positive expected realized net after costs.
