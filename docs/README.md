...
This page is the documentation entry point. Keep `AGENTS.md` small enough to
load as operating law; move runbooks and implementation notes here.
...
4. `docs/skill-usage-guidelines.md` - current delegation matrix for Grok and other agent sessions under Execution Mode.
5. `docs/ai-agent-operations.md` - runtime notes for Codex-aligned Grok prompts and legacy agent surfaces.
...
- `docs/skill-usage-guidelines.md` - current optional-skill usage model (graphify first, readiness skill, verifier-agent, direct execution default).
...
- `docs/superpowers/` - historical plans and specs. Advisory only; never overrides `AGENTS.md`.

## Hygiene Rules

- Put durable rules in `AGENTS.md`.
- Put runtime setup notes and role-specific workflows in focused `docs/*.md` runbooks.
