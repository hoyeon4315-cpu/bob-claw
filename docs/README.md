...
5. `docs/ai-agent-operations.md` - Ollama + Claude Code + subagent setup.
6. `docs/current-status.md` - generated/local status snapshot when present. Treat it as operational output, not policy.
